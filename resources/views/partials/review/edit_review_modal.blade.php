    ...
    <div class="modal-content">
      ...
      <form method="post" id="form_edit_review"> {{-- define action in js --}}
        ...
        <div class="modal-body">
          <p style="margin-bottom: 0 !important;">Chọn đánh giá</p>
          ...
          <div class="mb-3">
            <label for="review_edit" class="col-form-label">Đánh giá</label>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-outline-dark mt-2" id="button_edit_review">Gửi</button>
        </div>
      </form>
    </div>
  </div>
